<script lang="ts">
  import type { RatingData } from "$lib/server/repository/result.repo";
  ...
  function getBadgeColorClass(color?: string | null): string {
    if (!color) return "bg-purple-200 text-purple-600";
    ...
    return colorMap[color] || "bg-purple-200 text-purple-600";
  }
        ...
        <div class="col-span-3 flex items-center gap-2">
          ...
          <div class="progress-bar-container">
            <div class="progress-bar-track">
              <div
                class="progress-bar-fill progress-bar-{split(rating.color) || 'info'}"
