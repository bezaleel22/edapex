...
import { JWT_SIGN_SECRET, JWE_ENC_SECRET } from "$env/static/private";
import crypto from "crypto";

const SECRET = new TextEncoder().encode(JWT_SIGN_SECRET);
const JWE_SECRET = base64url.decode(JWE_ENC_SECRET!);
